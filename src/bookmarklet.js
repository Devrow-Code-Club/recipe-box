(_ => {
  ...
  function pullRecipeCard() {
    ...
    if (document.querySelector('body.recipe-template-default')) return buildRecipeCard('.wpurp-recipe-title, .recipe-title', '.wpurp-recipe-ingredients li, .recipe-ingredients__list li', '.wpurp-recipe-instructions li, .recipe-directions__list .recipe-directions__item')
